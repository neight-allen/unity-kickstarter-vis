...
public class KeyboardCameraControl : MonoBehaviour
{
    ...
    public enum KeyboardAxis { Horizontal = 0, Vertical = 1, MouseX = 2, MouseY = 3, JoyX = 4, JoyY = 5, None = 6 }
    ...
    public string mouseXName = "MouseX";
    public string mouseYName = "MouseY";
    public string joyXName = "JoyX";
    public string joyYName = "JoyY";


    private string[] keyboardAxesNames;
    void Start()
    {
        keyboardAxesNames = new string[] { keyboardHorizontalAxisName, keyboardVerticalAxisName, mouseXName, mouseYName, joyXName, joyYName};
    }
